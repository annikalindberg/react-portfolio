...
import { ContactIcons } from 'styledComponents/Icons';
import profileSquare from '../assets/profil-square.jpg';
import { ContactIconsWrapper, HeadlineWrapper, ProfileImageWrapper } from '../styledComponents/Wrappers';
...
font-style: normal;
font-weight: 400;
line-height: normal; // 1.5rem or 24px
`;
...
const Hero = () => {
  return (
    <HeadlineWrapper>
      ...
      <ContactIconsWrapper>
              <ContactIcons>
                  <a href='https://www.linkedin.com/in/annika-lindberg-1b1a0b1b0/'>target='_blank' rel='noreferrer' alt="LinkedIn icon"
                      <img src="xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
